...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int countOfNumbers = Integer.parseInt(console.nextLine());
        ...
        String line;
        while (true) {
            if ("party over".equals(line = console.nextLine())) {
                break;
            }
                    ...
                    switch (pattern) {
                        case 1:
                           changeValueToOne(numbers, position);
                            break;
                        case 0:
                            chageValueToZero(numbers, position);
                            break;
                        case -1:
        ...
        private static void chageValueToZero(int[] numbers, int postion){
            for (int i = 0; i <numbers.length ; i++) {
